...
- Generated at: 2026-03-16T13:58:48.057Z
...
6. Open cart [action=click, target={"type":"role","role":"link","name":"Cart"}, value=""]
7. Verify text Shopping Cart [action=assertVisible, target={"type":"text","value":"Shopping Cart"}, value=""]
8. Verify text Subtotal [action=assertVisible, target={"type":"text","value":"Subtotal"}, value=""]
