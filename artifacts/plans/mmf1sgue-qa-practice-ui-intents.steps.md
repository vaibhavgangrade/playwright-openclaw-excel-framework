...
- Generated at: 2026-03-06T15:27:01.958Z
...
5. Click Button text [action=click, target={"type":"text","value":"Button text"}]
6. Press Click button [action=click, target={"type":"role","role":"button","name":"Click"}]
7. Click Checkbox text [action=click, target={"type":"text","value":"Checkbox text"}]
