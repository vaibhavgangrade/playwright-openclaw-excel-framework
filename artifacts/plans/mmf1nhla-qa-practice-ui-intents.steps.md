...
- Generated at: 2026-03-06T15:23:09.646Z
...
2. Click Text Input [action=click, target={"type":"text","value":"Text Input"}]
3. Enter Vaibhav into the Submit me [action=fill, target={"type":"text","value":"the Submit me"}, value="Vaibhav"]
4. Press Enter [action=press, target=N/A, value="Enter"]
5. Verify text Vaibhav on page. [action=assertVisible, target={"type":"text","value":"Vaibhav on page."}]
6. Click Button text [action=click, target={"type":"text","value":"Button text"}]
7. Press Click button [action=click, target={"type":"role","role":"button","name":"Click"}]
8. Click Checkbox text [action=click, target={"type":"text","value":"Checkbox text"}]
9. Select checkbox option [action=click, target={"type":"role","role":"checkbox","name":"Select me or not"}]
...
```json
{
  "plan": {
    ...
    "steps": [
      ...
      {
        "name": "Enter Vaibhav into the Submit me",
        "action": "fill",
        "target": {
          "type": "text",
          "value": "the Submit me"
