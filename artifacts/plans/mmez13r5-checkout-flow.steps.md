...
- Generated at: 2026-03-06T14:09:46.049Z
...
2. Open a laptop result [action=click, target={"type":"role","role":"link","name":"laptop"}]
3. Open cart [action=click, target={"type":"role","role":"link","name":"Cart"}]
4. Proceed to checkout [action=click, target={"type":"role","role":"button","name":"Proceed to checkout"}]
5. Verify credit card form is visible [action=assertVisible, target={"type":"text","value":"Credit card"}]
